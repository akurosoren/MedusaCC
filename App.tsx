...
type View = 'dashboard' | 'personal' | 'jellyfin' | 'automation' | 'settings';
...
const MainApp: React.FC = () => {
    ...
    const [view, setView] = useState<View>(currentUser?.role === 'admin' ? 'dashboard' : 'personal');
    ...
    const renderView = () => {
        ...
        switch (view) {
            ...
            case 'settings':
                return <Settings />;
            default:
                return currentUser?.role === 'admin' ? <Dashboard /> : <PersonalHub />;
        }
    };
